...
from components.Data_Recovery_DevOps import comp_recovery_devops_overview, comp_recovery_devops_analyzer, comp_dcm_adoption, comp_git_integration, comp_cicd_automation, comp_declarative_pipeline, comp_orchestration_patterns, comp_devops_maturity_summary
